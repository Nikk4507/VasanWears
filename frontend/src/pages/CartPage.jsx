  ...
  return (
    <div className="md:mt-35 mt-30">
      ...
      <div className="container mx-auto px-5 py-5 md:py-20">
        <h3 className="md:text-3xl text-xl font-semibold mb-5 md:mb-10 text-center">
          Shopping Cart
        </h3>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow h-fit">
            {/* Header */}
            <div className="grid grid-cols-12 px-6 py-4 border-b text-sm font-medium text-gray-500">
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="grid grid-cols-12 px-6 py-6 items-center border-b last:border-none"
              >
                {/* PRODUCT */}
                <div className="col-span-6 flex gap-4">
                  <button onClick={() => removeItem(item.id)} className="text-gray-400 hover:text-red-500 text-xl cursor-pointer">
                    ×
                  </button>
                ...
                <div className="col-span-2 flex justify-center">
                  <div className="flex items-center border rounded-full overflow-hidden">
                    <button onClick={() => decreaseQty(item.id)} className="px-3 py-1 text-lg cursor-pointer">−</button>
                    <span className="px-3">{item.quantity}</span>
                    <button onClick={() => increaseQty(item.id)} className="px-3 py-1 text-lg cursor-pointer">+</button>
                  </div>
                </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow h-fit w-full sticky top-35">
            ...
            <div className="space-y-3 text-sm mb-6">
              ...
              <div className="flex justify-between">
                <span>Delivery</span>
                <span className="text-primary1 font-semibold">Free</span>
              </div>
